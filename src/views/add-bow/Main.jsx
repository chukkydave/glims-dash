...
import { createBow } from '../../features/BOW/bowSlice';
...
const Main = () => {
    ...
    const handleSubmit = () => {
        ...
        dispatch(createBow(data))
            .then((res) => {
                setLoading(false);
                console.log(res)
                if (res.type === "bows/createBow/fulfilled") {
                    setDuration('')
                    setDate('')
                    setWeek('')
                    setTitle('')
        ...
        <>
            {!editCourse ? (<div>
                <div className="intro-y flex flex-col sm:flex-row items-center mt-8">
                    <h2 className="text-lg font-medium mr-auto">Add Bow</h2>
