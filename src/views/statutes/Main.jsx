...
import { selectAllStatutes, fetchStatutes, deleteStatute } from "../../features/statutes/statutesSlice"
...
function Main() {
    ...
    const handleDelete = () => {
        setDeleteConfirmationModal(false)
        dispatch(deleteStatute(selectedId))
            .then((res) => {
                console.log(res)
                if (res.type === "statutes/deleteStatute/fulfilled") {
                    Toastify({
    ...
    return (
        <>
            <h2 className="intro-y text-lg font-medium mt-10">Statutes List</h2>
                    ...
                    <table className="table table-report -mt-2">
                        <thead>
                            <tr>
                                ...
                                <th className="whitespace-nowrap">Statute Topic</th>
                                ...
                                <tr key={item._id} className="intro-x">
                                    ...
                                    <td className="table-report__action w-56">
                                        <div className="flex justify-center items-center">
                                            <Link className="flex items-center mr-3" to={`/edit-statute/${item._id}`}>
