...
import { selectAllQuestions, fetchQuestions, deleteQuestion } from "../../features/past-questions/pastQuestionsSlice"
...
function Main() {
    ...
    return (
        <>
            <h2 className="intro-y text-lg font-medium mt-10">Past Question List</h2>
            <div className="grid grid-cols-12 gap-6 mt-5">
                <div className="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                    <Link to="/add-past-question">
                                ...
                                <tr key={item._id} className="intro-x">
                                    ...
                                    <td className="table-report__action w-56">
                                        <div className="flex justify-center items-center">
                                            ...
                                            <Link className="flex items-center mr-3" to={`/edit-past-question/${item._id}`}>
