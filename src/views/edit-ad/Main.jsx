...
import { updateAd, selectAllAds, fetchAds } from "../../features/ads/adSlice";
...
function Main() {
    ...
    useEffect(() => {
        const filtered = ads.filter(item => item._id === id);
        if (filtered.length > 0) {
            console.log(filtered)
            setAdName(filtered[0].adTitle)
            setAdIcon(filtered[0].backgroundImages[0].image)
            setAdIconShow(filtered[0].backgroundImages[0].image)
            setAdLink(filtered[0].backgroundImages[0].link)
        }
    ...
    const submitForm = async () => {
        ...
        try {
            ...
            dispatch(updateAd(model)).then((res) => {
                console.log(res)
                if (res.type === "ads/updateAd/fulfilled") {
                    setAdName('')
                    setAdIcon('')
                    Toastify({
    ...
    return (
        <>
            <div className="intro-y flex items-center mt-8">
                <h2 className="text-lg font-medium mr-auto">Edit Ad</h2>
            </div>
                ...
                >
                    ...
                    <div className="ml-4 mr-4">
                        ...
                        <div className="text-slate-500 mt-1">
                            Ad has been updated successfully!
                        </div>
                    </div>
                </div>
