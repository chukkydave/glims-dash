...
import { selectAllDrafts, fetchDrafts, deleteDraft } from "../../features/drafts/draftsSlice"
...
function Main() {
    ...
    const handleDelete = () => {
        setDeleteConfirmationModal(false)
        dispatch(deleteDraft(selectedId))
            .then((res) => {
                console.log(res)
                if (res.type === "drafts/deleteDraft/fulfilled") {
                    Toastify({
                                ...
                                <tr key={item._id} className="intro-x">
                                    ...
                                    <td className="table-report__action w-56">
                                        <div className="flex justify-center items-center">
                                            ...
                                            <Link className="flex items-center mr-3" to={`/edit-draft/${item._id}`}>
