      ...
      <div className="shadow-md fixed bottom-0 right-0 box border rounded-full h-12 px-5 flex items-center justify-center z-50 mb-10 mr-52">
        ...
        <a
          ...
          className={classnames({
            "block w-8 h-8 cursor-pointer bg-indigo-800 rounded-full border-4 mr-1 hover:border-slate-200": true,
        ...
        <a
          ...
          className={classnames({
            "block w-8 h-8 cursor-pointer bg-blue-900 rounded-full border-4 hover:border-slate-200": true,
            "border-slate-300 dark:border-darkmode-800/80":
              colorScheme == "theme-4",
        ...
        <a
          onClick={() => {
            switchColorScheme("theme-5");
          }}
          className={classnames({
            "block w-8 h-8 cursor-pointer bg-purple-900 rounded-full border-4 hover:border-slate-200": true,
            "border-slate-300 dark:border-darkmode-800/80":
              colorScheme == "theme-5",
            "border-white dark:border-darkmode-600": colorScheme != "theme-5",
          })}
        ></a>
      </div>
